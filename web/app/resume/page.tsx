    ...
    <main>
      ...
      <section>
        <div className="container border-x border-border">
          <div className="grid grid-cols-1 md:grid-cols-[3fr_1fr] gap-x-8">
            <div className="border-b -mx-8 px-4 md:mx-0 md:px-0 md:border-b-0 md:order-1 md:border-l border-border max-md:sticky top-0 bg-background/80 backdrop-blur-md">
              <div className="py-4 md:pl-4 md:py-12 lg:py-24 md:sticky top-0 left-0">
                <ResumeActions />
              </div>
            </div>
            <div className="py-12 lg:py-24">
